...
import 'package:finalbesttutor/become_a_tutor/iteamstutor/profile2/tutorjobs/alljobs/alljobsdtails.dart';
...
import '../hire_a_tutor/curvednavigationbar/itemesguardian/jobstatus/jobstatusitems/pendingjob/pendingjob_details.dart';
...
class AppRoures {
  static approute() => [
        ...
        GetPage(
            ...
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.curvednavbar,
            page: () => Curvednavigationbar(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.curvednavbar2,
            page: () => Curvednav2(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.tutorotp,
            page: () => Tutorotp(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.guardianotp,
            page: () => Guardianotp(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.flotingactionbutton,
            page: () => FlottingactionButton(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
        ...
        GetPage(
            ...
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.flottingactionbutton2,
            page: () => FlottingactionButton2(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.profile2,
            page: () => Profile2(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.tutionrelated,
            page: () => TutionrelatedInfo(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.educational,
            page: () => EducationalInfo(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
        ...
        GetPage(
            ...
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.viweprofile,
            page: () => ViweProfile(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.viwe_downloadcv,
            page: () => Viwe_Download_cv(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.pendingjobdtails,
            page: () => PendingJobDetails(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
        GetPage(
            name: RouteName.alljobdtails,
            page: () => AlljobsDtails(),
            transitionDuration: Duration(milliseconds: 250),
            transition: Transition.leftToRightWithFade),
      ];
