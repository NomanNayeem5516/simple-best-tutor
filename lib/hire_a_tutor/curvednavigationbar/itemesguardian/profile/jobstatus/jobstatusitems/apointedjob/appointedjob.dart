...
class AppointedJobGerdian extends StatefulWidget {
  const AppointedJobGerdian({super.key});

  @override
  State<AppointedJobGerdian> createState() => _AppointedJobGerdianState();
}

class _AppointedJobGerdianState extends State<AppointedJobGerdian>
